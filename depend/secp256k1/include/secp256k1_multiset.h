 ...
 *  Returns: 1:
 *  Args:        ctx:  pointer to a context object (cannot be NULL)
 *  Out:       out64:  pointer to a 64-byte array to store the serialized multiset
 *  In:    multiset:   pointer to the multiset
 */
 ...
 *  Args:        ctx:  pointer to a context object (cannot be NULL)
 *  Out:    multiset:  pointer to a multiset object
 *  In:         in64:  pointer to the 64-byte multiset to be parsed
 */
